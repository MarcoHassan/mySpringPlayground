...
import com.example.springboot.environmentVariables;
...
public class ListBlobs {
	...
	public void listAvailableBlobs() throws IOException {
        ...
        BlobContainerClient blobClient = new BlobContainerClientBuilder()
                ...
                .endpoint(environmentVariables.BlobContainerEndpoint.getEnvVar() )
                .buildClient();
	...
	public String createBlob() throws IOException {
        ...
        String connectStr = environmentVariables.AZURE_STORAGE_CONNECTION_STRING.getEnvVar(); 
        ...
        BlobServiceClient blobServClient = new BlobServiceClientBuilder()
                ...
                .endpoint(environmentVariables.pocETLblob.getEnvVar())
                .buildClient();
